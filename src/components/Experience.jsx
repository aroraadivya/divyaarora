...
const jobs = [
  ...
  },
  {
    ...
    desc: 'Led a cross-functional team of 9 as Scrum Master, facilitating daily stand-ups, sprint planning, and retrospectives in a fast-paced Agile environment. Simultaneously built a full iOS application from scratch using Swift and SwiftUI, following MVVM architecture with RESTful API integration.',
